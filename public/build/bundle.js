    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div8 = element("div");
    			img5 = element("img");
    			add_location(h1, file$4, 190, 8, 7768);
    			attr_dev(p, "class", "svelte-rsofme");
    			add_location(p, file$4, 191, 8, 7816);
    			attr_dev(div0, "class", "over animate svelte-rsofme");
    			add_location(div0, file$4, 189, 4, 7712);
    			attr_dev(div1, "class", "over-background svelte-rsofme");
    			add_location(div1, file$4, 188, 0, 7649);
    			if (img0.src !== (img0_src_value = "/images/play.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "previous");
    			attr_dev(img0, "class", "prev-button svelte-rsofme");
    			add_location(img0, file$4, 199, 28, 8055);
    			attr_dev(div2, "class", "prev svelte-rsofme");
    			add_location(div2, file$4, 198, 24, 7979);
    			attr_dev(h3, "class", "fade svelte-rsofme");
    			add_location(h3, file$4, 206, 28, 8393);
    			...
    			attr_dev(img1, "class", "svelte-rsofme");
    			add_location(img1, file$4, 209, 32, 8534);
    			attr_dev(div3, "class", "first-front fade svelte-rsofme");
    			add_location(div3, file$4, 208, 28, 8470);
    			if (img2.src !== (img2_src_value = "/images/git-over.png")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "git");
    			attr_dev(img2, "class", "svelte-rsofme");
    			add_location(img2, file$4, 213, 107, 8820);
    			add_location(h40, file$4, 213, 150, 8863);
    			attr_dev(div4, "class", "git-over svelte-rsofme");
    			add_location(div4, file$4, 213, 32, 8745);
    			if (img3.src !== (img3_src_value = "/images/url-over.png")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "git");
    			attr_dev(img3, "class", "svelte-rsofme");
    			add_location(img3, file$4, 214, 144, 9028);
    			add_location(h41, file$4, 214, 187, 9071);

    			attr_dev(div5, "class", div5_class_value = "" + (null_to_empty(/*url*/ ctx[2]
    			? "url-over visible"
    			: "url-over invisible") + " svelte-rsofme"));

    			add_location(div5, file$4, 214, 32, 8916);
    			attr_dev(button, "class", "see-description svelte-rsofme");
    			add_location(button, file$4, 215, 32, 9128);
    			attr_dev(div6, "class", "first-menu fade svelte-rsofme");
    			add_location(div6, file$4, 212, 28, 8682);
    			attr_dev(img4, "class", "swipe svelte-rsofme");
    			attr_dev(img4, "alt", "handtouch");
    			if (img4.src !== (img4_src_value = "/images/swipe.png")) attr_dev(img4, "src", img4_src_value);
    			add_location(img4, file$4, 221, 28, 9466);
    			attr_dev(div7, "class", div7_class_value = "" + (null_to_empty(/*animate*/ ctx[3] ? "first animationtesteo" : "first") + " svelte-rsofme"));
    			add_location(div7, file$4, 203, 24, 8198);
    			if (img5.src !== (img5_src_value = "/images/play.png")) attr_dev(img5, "src", img5_src_value);
    			attr_dev(img5, "alt", "previous");
    			attr_dev(img5, "class", "next-button svelte-rsofme");
    			add_location(img5, file$4, 229, 28, 9788);
    			attr_dev(div8, "class", "next svelte-rsofme");
    			add_location(div8, file$4, 228, 24, 9712);
    			attr_dev(div9, "class", "carousel svelte-rsofme");
    			add_location(div9, file$4, 196, 8, 7886);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div1, "click", /*closeDescription*/ ctx[11], false, false, false),
    					listen_dev(div2, "click", /*handleClickPrev*/ ctx[6], false, false, false),
    					listen_dev(div4, "click", /*click_handler*/ ctx[13], false, false, false),
    					listen_dev(div5, "click", /*click_handler_1*/ ctx[14], false, false, false),
    					listen_dev(button, "click", /*seeDescription*/ ctx[10], false, false, false),
    					listen_dev(div7, "touchstart", /*touchstart_handler*/ ctx[15], false, false, false),
    					listen_dev(div7, "touchmove", /*touchmove_handler*/ ctx[16], false, false, false),
    					listen_dev(div8, "click", /*handleClickNext*/ ctx[5], false, false, false),
    					action_destroyer(watchResize_action = watchResize.call(null, div9, /*resize*/ ctx[7]))
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*animate*/ 8 && div7_class_value !== (div7_class_value = "" + (null_to_empty(/*animate*/ ctx[3] ? "first animationtesteo" : "first") + " svelte-rsofme"))) {
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h4, "class", "menu-modal-item svelte-1p270x4");
    			set_style(h4, "color", "white");
    			set_style(h4, "background-color", "black");
    			add_location(h4, file$5, 109, 1, 2722);
    			attr_dev(span, "class", "menu-modal-item svelte-1p270x4");
    			...
    			attr_dev(div, "class", "menu-modal svelte-1p270x4");
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-1p270x4");
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-1p270x4");
    			add_location(img, file$5, 120, 1, 3361);
    			attr_dev(main, "class", "svelte-1p270x4");

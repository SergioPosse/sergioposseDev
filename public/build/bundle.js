...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h4, "class", "svelte-f2nbkd");
    			add_location(h4, file$1, 16, 16, 345);
    			set_style(span0, "background-color", "rgb(158, 226, 242,0)");
    			set_style(span0, "color", "rgb(224, 255, 255,0.7)");
    			attr_dev(span0, "class", "svelte-f2nbkd");
    			add_location(span0, file$1, 17, 12, 429);
    			attr_dev(span1, "style", "background-color:rgb(224, 100, 100,0);color:rgb(224, 255, 255,0.7););");
    			attr_dev(span1, "class", "svelte-f2nbkd");
    			add_location(span1, file$1, 18, 12, 560);

    			attr_dev(div0, "class", div0_class_value = "" + (null_to_empty(/*visible*/ ctx[0]
    			? "menu-modal visible"
    			: "menu-modal invisible") + " svelte-f2nbkd"));

    			add_location(div0, file$1, 15, 8, 235);
    			...
    			add_location(img, file$1, 23, 8, 960);
    			attr_dev(div1, "class", "about svelte-f2nbkd");
    			add_location(div1, file$1, 24, 8, 1031);
    			attr_dev(div2, "class", "portfolio svelte-f2nbkd");
    			add_location(div2, file$1, 27, 8, 1095);
    			attr_dev(nav, "class", "svelte-f2nbkd");
    			add_location(nav, file$1, 14, 1, 220);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(span1, "click", /*handlePdfClick*/ ctx[2], false, false, false),
    					listen_dev(div0, "mouseout", /*clickMenu*/ ctx[1], false, false, false),
    					listen_dev(img, "click", /*clickMenu*/ ctx[1], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*visible*/ 1 && div0_class_value !== (div0_class_value = "" + (null_to_empty(/*visible*/ ctx[0]
    			? "menu-modal visible"
    			: "menu-modal invisible") + " svelte-f2nbkd"))) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ visible, clickMenu, handlePdfClick });
    	...
    	return [visible, clickMenu, handlePdfClick];
    }
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img.src !== (img_src_value = "/images/up.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "open-footer");
    			attr_dev(img, "class", "svelte-jtx3rl");
    			add_location(img, file$4, 63, 2, 1487);
    			attr_dev(div, "class", "button-footer svelte-jtx3rl");
    			add_location(div, file$4, 62, 1, 1416);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div, "click", /*openFooter*/ ctx[5], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    // (60:1) {#if ((showFooter===true)||(openf===true) )}
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(60:1) {#if ((showFooter===true)||(openf===true) )}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	function about_skillsEl_binding(value) {
    		/*about_skillsEl_binding*/ ctx[6].call(null, value);
    	}

    	function about_whoEl_binding(value) {
    		/*about_whoEl_binding*/ ctx[7].call(null, value);
    	}

    	let about_props = {};

    	if (/*skillsEl*/ ctx[2] !== void 0) {
    		about_props.skillsEl = /*skillsEl*/ ctx[2];
    	}

    	if (/*whoEl*/ ctx[3] !== void 0) {
    		about_props.whoEl = /*whoEl*/ ctx[3];
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			if_block.c();
    			attr_dev(main, "class", "svelte-jtx3rl");
    			add_location(main, file$4, 55, 0, 1210);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = action_destroyer(watchResize_action = watchResize.call(null, main, /*resize*/ ctx[4]));
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (!updating_skillsEl && dirty & /*skillsEl*/ 4) {
    				updating_skillsEl = true;
    				about_changes.skillsEl = /*skillsEl*/ ctx[2];
    				add_flush_callback(() => updating_skillsEl = false);
    			}

    			if (!updating_whoEl && dirty & /*whoEl*/ 8) {
    				updating_whoEl = true;
    				about_changes.whoEl = /*whoEl*/ ctx[3];
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("skillsEl" in $$props) $$invalidate(2, skillsEl = $$props.skillsEl);
    		if ("whoEl" in $$props) $$invalidate(3, whoEl = $$props.whoEl);
    	};

    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div8 = element("div");
    			img5 = element("img");
    			add_location(h1, file$4, 227, 8, 8231);
    			attr_dev(p, "class", "svelte-p3st87");
    			add_location(p, file$4, 228, 8, 8279);
    			attr_dev(div0, "class", "over animate svelte-p3st87");
    			add_location(div0, file$4, 226, 4, 8175);
    			attr_dev(div1, "class", "over-background svelte-p3st87");
    			add_location(div1, file$4, 225, 0, 8112);
    			if (img0.src !== (img0_src_value = "/images/play.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "previous");
    			attr_dev(img0, "class", "prev-button svelte-p3st87");
    			add_location(img0, file$4, 236, 28, 8518);
    			attr_dev(div2, "class", "prev svelte-p3st87");
    			add_location(div2, file$4, 235, 24, 8442);
    			attr_dev(h3, "class", "fade svelte-p3st87");
    			add_location(h3, file$4, 243, 28, 8856);
    			...
    			attr_dev(img1, "class", "svelte-p3st87");
    			add_location(img1, file$4, 246, 32, 8997);
    			attr_dev(div3, "class", "first-front fade svelte-p3st87");
    			add_location(div3, file$4, 245, 28, 8933);
    			if (img2.src !== (img2_src_value = "/images/git-over.png")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "git");
    			attr_dev(img2, "class", "svelte-p3st87");
    			add_location(img2, file$4, 250, 107, 9283);
    			add_location(h40, file$4, 250, 150, 9326);
    			attr_dev(div4, "class", "git-over svelte-p3st87");
    			add_location(div4, file$4, 250, 32, 9208);
    			if (img3.src !== (img3_src_value = "/images/url-over.png")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "git");
    			attr_dev(img3, "class", "svelte-p3st87");
    			add_location(img3, file$4, 251, 144, 9491);
    			add_location(h41, file$4, 251, 187, 9534);

    			attr_dev(div5, "class", div5_class_value = "" + (null_to_empty(/*url*/ ctx[2]
    			? "url-over visible"
    			: "url-over invisible") + " svelte-p3st87"));

    			add_location(div5, file$4, 251, 32, 9379);
    			attr_dev(button, "class", "see-description svelte-p3st87");
    			add_location(button, file$4, 252, 32, 9591);
    			attr_dev(div6, "class", "first-menu fade svelte-p3st87");
    			add_location(div6, file$4, 249, 28, 9145);
    			attr_dev(img4, "class", "swipe svelte-p3st87");
    			attr_dev(img4, "alt", "handtouch");
    			if (img4.src !== (img4_src_value = "/images/swipe.png")) attr_dev(img4, "src", img4_src_value);
    			add_location(img4, file$4, 258, 28, 9929);
    			attr_dev(div7, "class", div7_class_value = "" + (null_to_empty(/*animate*/ ctx[3] ? "first animationtesteo" : "first") + " svelte-p3st87"));
    			add_location(div7, file$4, 240, 24, 8661);
    			if (img5.src !== (img5_src_value = "/images/play.png")) attr_dev(img5, "src", img5_src_value);
    			attr_dev(img5, "alt", "previous");
    			attr_dev(img5, "class", "next-button svelte-p3st87");
    			add_location(img5, file$4, 266, 28, 10251);
    			attr_dev(div8, "class", "next svelte-p3st87");
    			add_location(div8, file$4, 265, 24, 10175);
    			attr_dev(div9, "class", "carousel svelte-p3st87");
    			add_location(div9, file$4, 233, 8, 8349);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*animate*/ 8 && div7_class_value !== (div7_class_value = "" + (null_to_empty(/*animate*/ ctx[3] ? "first animationtesteo" : "first") + " svelte-p3st87"))) {

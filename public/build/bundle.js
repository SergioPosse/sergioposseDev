...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h4, "class", "menu-modal-item svelte-1ldbo9y");
    			set_style(h4, "color", "white");
    			set_style(h4, "background-color", "black");
    			add_location(h4, file$1, 6, 12, 109);
    			attr_dev(span0, "class", "menu-modal-item svelte-1ldbo9y");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-1ldbo9y");
    			add_location(img, file$1, 11, 8, 577);
    			attr_dev(div0, "class", "about svelte-1ldbo9y");
    			add_location(div0, file$1, 12, 8, 648);
    			attr_dev(div1, "class", "portfolio svelte-1ldbo9y");
    			add_location(div1, file$1, 15, 8, 712);
    			attr_dev(nav, "class", "svelte-1ldbo9y");
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-16l5mw3");
    			add_location(img, file$2, 28, 54, 893);
    			attr_dev(div0, "class", "button-footer2 svelte-16l5mw3");
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			img3 = element("img");
    			attr_dev(canvas, "class", "svelte-1lhqttz");
    			add_location(canvas, file$3, 23, 0, 556);
    			set_style(input0, "position", "absolute");
    			set_style(input0, "left", "-9999px");
    			attr_dev(input0, "id", "justCopy");
    			input0.value = "SergioDavidPosse@gmail.com";
    			...
    			attr_dev(img0, "class", "svelte-1lhqttz");
    			...
    			attr_dev(img2, "class", "svelte-1lhqttz");
    			...
    			attr_dev(img3, "class", "svelte-1lhqttz");
    			add_location(img3, file$3, 35, 4, 1399);
    			attr_dev(social, "class", "svelte-1lhqttz");
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$4, 111, 2, 2796);
    			attr_dev(div, "class", "button-footer svelte-1xxrcdr");
    			add_location(div, file$4, 110, 1, 2725);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, img);
    			...
    			if (!mounted) {
    				dispose = listen_dev(div, "click", /*openFooter*/ ctx[9], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    // (108:1) {#if ((showFooter===true)||(openf===true) )}
    function create_if_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(108:1) {#if ((showFooter===true)||(openf===true) )}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	function nav_modalMenu_binding(value) {
    		/*nav_modalMenu_binding*/ ctx[10].call(null, value);
    	}

    	function nav_hideMenu_binding(value) {
    		/*nav_hideMenu_binding*/ ctx[11].call(null, value);
    	}
    	...
    	function social_canvasSocialSide_binding(value) {
    		/*social_canvasSocialSide_binding*/ ctx[12].call(null, value);
    	}

    	function social_socialSide_binding(value) {
    		/*social_socialSide_binding*/ ctx[13].call(null, value);
    	}

    	let social_props = {};

    	if (/*canvasSocialSide*/ ctx[5] !== void 0) {
    		social_props.canvasSocialSide = /*canvasSocialSide*/ ctx[5];
    	}

    	if (/*socialSide*/ ctx[4] !== void 0) {
    		social_props.socialSide = /*socialSide*/ ctx[4];
    	}
    	...
    	function about_skillsEl_binding(value) {
    		/*about_skillsEl_binding*/ ctx[14].call(null, value);
    	}

    	function about_whoEl_binding(value) {
    		/*about_whoEl_binding*/ ctx[15].call(null, value);
    	}

    	let about_props = {};

    	if (/*skillsEl*/ ctx[6] !== void 0) {
    		about_props.skillsEl = /*skillsEl*/ ctx[6];
    	}

    	if (/*whoEl*/ ctx[7] !== void 0) {
    		about_props.whoEl = /*whoEl*/ ctx[7];
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$4, 103, 0, 2398);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = action_destroyer(watchResize_action = watchResize.call(null, main, /*resize*/ ctx[8]));
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (!updating_canvasSocialSide && dirty & /*canvasSocialSide*/ 32) {
    				updating_canvasSocialSide = true;
    				social_changes.canvasSocialSide = /*canvasSocialSide*/ ctx[5];
    				add_flush_callback(() => updating_canvasSocialSide = false);
    			}

    			if (!updating_socialSide && dirty & /*socialSide*/ 16) {
    				updating_socialSide = true;
    				social_changes.socialSide = /*socialSide*/ ctx[4];
    			...
    			if (!updating_skillsEl && dirty & /*skillsEl*/ 64) {
    				updating_skillsEl = true;
    				about_changes.skillsEl = /*skillsEl*/ ctx[6];
    				add_flush_callback(() => updating_skillsEl = false);
    			}

    			if (!updating_whoEl && dirty & /*whoEl*/ 128) {
    				updating_whoEl = true;
    				about_changes.whoEl = /*whoEl*/ ctx[7];
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	function social_canvasSocialSide_binding(value) {
    		canvasSocialSide = value;
    		$$invalidate(5, canvasSocialSide);
    	}

    	function social_socialSide_binding(value) {
    		socialSide = value;
    		$$invalidate(4, socialSide);
    	}

    	function about_skillsEl_binding(value) {
    		skillsEl = value;
    		$$invalidate(6, skillsEl);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("socialSide" in $$props) $$invalidate(4, socialSide = $$props.socialSide);
    		if ("canvasSocialSide" in $$props) $$invalidate(5, canvasSocialSide = $$props.canvasSocialSide);
    		if ("skillsEl" in $$props) $$invalidate(6, skillsEl = $$props.skillsEl);
    		if ("whoEl" in $$props) $$invalidate(7, whoEl = $$props.whoEl);
    	};
